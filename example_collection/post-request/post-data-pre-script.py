...
if 'LAST_ORIGIN_IP' in env:
    print(f"[REQ PRE Script]: The previous request (GET) saved the IP: {env['LAST_ORIGIN_IP']}")
else:
    ...
    if 'LAST_origin_ip' not in env:
        env['LAST_ORIGIN_IP'] = "not-defined"